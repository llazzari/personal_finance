...
from components.modals.helpers import buttons_row, footer, toggle_and_upload
    ...
    return html.Div([
        dbc.Modal(
            [
                ...
                dbc.ModalFooter(
                    footer(i18n.t('general.close'), ids.CLOSE_CCBILL)
                ),
            ],
            id=ids.CCBILL_MODAL,
            is_open=False,
...
@callback(
    ...
    [
        Input(ids.OPEN_CCBILL, 'n_clicks'),
        Input(ids.CLOSE_CCBILL, 'n_clicks'),
        *[
